...
/* ymodule port */
#define  SerialKeyPressed(c)  (uart2_buf_read(c))
#define  SerialPutChar(c)        (uart2_send_char(c))
              ...
              else
              {
                ...
                else
                {
                  memcpy(buf_ptr, packet_data + PACKET_HEADER, packet_length);
                    ...
                    /* add by wangliang  */
                    if (drives_flash_packet_write_t((uint8_t*)buf,packet_length,packets_received) == 0) {
                        Send_Byte(ACK);
                    }
                    else {
                        Send_Byte(CA);
