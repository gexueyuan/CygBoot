/**
  ...
  * All rights reserved.
  *
  * @file   : cv_drives_sd_spi.c
  * @brief  : spi interface sd drives
  * @author : Fred
  * @history:
...
void MSD0_SPI_Configuration(void)
{
    ...
    RCC_AHB1PeriphClockCmd(SD_SPI_SCK_GPIO_CLK|SD_SPI_MISO_GPIO_CLK|SD_SPI_MOSI_GPIO_CLK|SD_SPI_CS_GPIO_CLK, ENABLE);
   ...
   // SPI_SSOutputCmd(SD_SPI,ENABLE);
    ...
    GPIO_SetBits(SD_SPI_CS_GPIO_PORT,SD_SPI_CS_PIN);
